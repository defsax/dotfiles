...
if [ "$color_prompt" = yes ]; then
    #PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
		export PS1="${bracketC}[${nameC}\u${atC}@${hostC}\h${colonC}: ${pathC}\w${gitC}\$(gitPrompt)${bracketC}]${pointerC}\$${normalC} "
		
		#PS1="$HC$FRED[$FYEL${debian_chroot:+($debian_chroot)}\u$FGRN@$FBLU\h$FYEL: $FMAG\w$FRED]$FWHT\\$ $RS"
		
		
		#PS1="$HC [ ${debian_chroot: + ($debian_chroot)} \u : \w ]\\$  $RS"
		PS2="$HC$FYEL&gt; $RS"
else
